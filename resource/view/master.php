    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="{{u('admin/index/index')}}" style="color: white;margin-left: -14px">JianBs Blog Cms</a>
                </h4>
                <div class="navbar-header">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="{{u('admin/article/store')}}" ><i class="fa fa-w fa-pencil"></i> 发布文章</a>
                        </li>
                    </ul>
                </div>
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{u('admin/userset/index')}}">设置</a></li>
                            <li><a href="{{u('admin/userset/out')}}">退出</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="col-xs-12 col-sm-3 col-lg-2 left-menu">
            <div class="panel panel-default" id="menus">
                ...
                <ul class="list-group menus collapse in" id="collapseExample3">
                    ...
                    <a href="{{u('admin/userset/index')}}" class="list-group-item">
