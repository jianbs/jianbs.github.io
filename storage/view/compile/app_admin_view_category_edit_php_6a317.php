    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="http://localhost/houdun/Jian_Blog/blog_two/index.php?s=admin/index/index" style="color: white;margin-left: -14px">JianBs Blog Cms</a>
                </h4>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="cname" value="<?php echo $oldData['cname']?>"  class="form-control" placeholder="请填写分类名称">
                    </div>
                </div>
                <div class="form-group">
               ...
               <?php }?>  ><?php echo $v['_cname']?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="ctitle" value="<?php echo $oldData['ctitle']?>"  class="form-control" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="csort" value="<?php echo $oldData['csort']?>"  class="form-control" placeholder="请填写分类名称">
                    </div>
                </div>
            </div>
        </div>
