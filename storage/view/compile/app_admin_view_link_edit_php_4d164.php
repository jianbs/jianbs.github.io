        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="lname"  class="form-control" value="<?php echo $oldData['lname']?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="url" name="url"  class="form-control" placeholder="" value="<?php echo $oldData['url']?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">排序</label>
                    <div class="col-sm-9">
                        <input type="number" name="sort"  class="form-control" placeholder="" value="<?php echo $oldData['sort']?>">
                    </div>
                </div>
            </div>
        </div>
