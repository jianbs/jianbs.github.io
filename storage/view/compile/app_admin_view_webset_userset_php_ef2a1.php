...
<head>
    ...
    <script>
        var hdjs = {
         //框架目录
        'base': '/resource/hdjs',
               'uploader': "http://localhost/houdun/Jian_Blog/blog/index.php?s=system/component/uploader",
               'filesLists': "http://localhost/houdun/Jian_Blog/blog/index.php?s=system/component/filesLists",
               'removeImage': "http://localhost/houdun/Jian_Blog/blog/index.php?s=system/component/removeImage"
           };
    </script>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <div class="navbar-header">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="http://localhost/houdun/Jian_Blog/blog/index.php?s=admin/article/store" ><i class="fa fa-w fa-pencil"></i> 发布文章</a>
                        </li>
                    </ul>
                </div>
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="http://localhost/houdun/Jian_Blog/blog/index.php?s=admin/webset/userset">设置</a></li>
                            <li><a href="">退出</a></li>
                        </ul>
                    </li>
                </ul>
        ...
        <div class="col-xs-12 col-sm-3 col-lg-2 left-menu">
            <div class="panel panel-default" id="menus">
                ...
                <ul class="list-group menus collapse in" id="collapseExample">
                    <a href="http://localhost/houdun/Jian_Blog/blog/index.php?s=admin/category/index" class="list-group-item">
                ...
                <ul class="list-group menus collapse in" id="collapseExample2">
                    <a href="http://localhost/houdun/Jian_Blog/blog/index.php?s=admin/tag/index" class="list-group-item">
                ...
                <ul class="list-group menus collapse in" id="collapseExample3">
                    <a href="http://localhost/houdun/Jian_Blog/blog/index.php?s=admin/article/index" class="list-group-item">
                        <i class="fa fa-newspaper-o" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        文章列表
                    </a>
                    <a href="http://localhost/houdun/Jian_Blog/blog/index.php?s=admin/article/recycleIndex" class="list-group-item">
                ...
                <ul class="list-group menus collapse in" id="collapseExample3">
                    <a href="http://localhost/houdun/Jian_Blog/blog/index.php?s=admin/link/index" class="list-group-item">
                ...
                <ul class="list-group menus collapse in" id="collapseExample3">
                    <a href="http://localhost/houdun/Jian_Blog/blog/index.php?s=admin/webset/index" class="list-group-item">
                        <i class="fa fa-wrench" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        站点配置
                    </a>
                    <a href="http://localhost/houdun/Jian_Blog/blog/index.php?s=admin/webset/userset" class="list-group-item">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="lname"  class="form-control" placeholder="" value=" <?php echo Session::get('username')?>">
                    </div>
                </div>
                <div class="form-group">
