...
<div class="container-fluid admin_menu">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li><a href="<?php echo u('index')?>">文章管理</a></li>
        <li class="active"><a href="">编辑文章</a></li>
    </ul>
    <!--    onsubmit="return store(this)"-->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="title" value="<?php echo $oldData['title']?>"  class="form-control" placeholder="文章标题">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">文章作者</label>
                    <div class="col-sm-9">
                        <input type="text" name="author" value="<?php echo $oldData['author']?>"  class="form-control" placeholder="文章作者">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <?php if(is_array($tagData) || is_object($tagData)){foreach ($tagData as $k=>$v){?>
                            <label class="checkbox-inline">
                                <input <?php if(in_array($v['tid'],$oldTag)){?>
                checked
               <?php }?> type="checkbox" name="tag[]" value="<?php echo $v['tid']?>"> <?php echo $v['tname']?>
                            </label>
                        <?php }}?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <input type="text" class="form-control" name="thumb" readonly="" value="<?php echo $oldData['thumb']?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="digest"   class="form-control" placeholder="文章摘要"><?php echo $oldData['digest']?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="keywords"   class="form-control" placeholder="关键字"><?php echo $oldData['keywords']?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">文章描述</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="des"   class="form-control" placeholder="文章摘要"><?php echo $oldData['des']?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">文章内容</label>
                    <div class="col-sm-9">
                        <script id="container" style="height:300px;width:100%;" name="content"><?php echo $oldData['content']?></script>
                        <script>
