...
<head>
    ...
    <meta name="keywords" content="<?php echo $headConf['keywords']?>" />
    <meta name="description" content="<?php echo $headConf['description']?>" />
    ...
    <div class="center-block clearfix">
        ...
        <div id="menu" class="fix-fish-menu">
            ...
            <ul id="nav" class="sf-menu">
                ...
                <li><a href="category_<?php echo $v['cid']?>.html"><?php echo $v['cname']?></a></li>
                <?php }}?>
...
<div id="footer">
    <div class="center-block">
        <div class="widget">
            ...
            <div>
                <span class="location"><?php echo $webSetData['Address']?></span>
                <span class="phone">4049896</span>
                <span class="email"><a href="mailto:<?php echo $webSetData['adminEmail']?>"><?php echo $webSetData['adminEmail']?></a></span>
            </div>
        </div><!-- .widget -->
...
<div id="footer-menu">
    <div class="center-block">
        <ul id="second-menu">
            <?php if(is_array($allLinkData) || is_object($allLinkData)){foreach ($allLinkData as $k=>$v){?>
            <li><a href="<?php echo $v['url']?>"><?php echo $v['lname']?></a></li>
            <?php }}?>

        </ul>
        <div class="copyright"><?php echo $webSetData['Copy']?> <a href="http://www.miitbeian.gov.cn/" target="_blank" style="color: white;">赣ICP备15007645号</a></div>
        <div class="clear"></div>
    </div><!-- .center-block -->
    <div class="clear"></div>
</div><!-- #footer-menu -->
