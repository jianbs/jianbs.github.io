        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <?php if(is_array($data['data']) || is_object($data['data'])){foreach ($data['data'] as $k=>$v){?>
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="<?php echo u('OutToRecycle',['aid'=>$v['aid']])?>">恢复文章</a></li>
                                    <li class="divider"></li>
                                    <li><a href="<?php echo u('del',['aid'=>$v['aid']])?>">彻底删除</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
