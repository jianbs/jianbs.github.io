        ...
        <div id="wrapper">
                ...
                <div class="center-block">
                    ...
                    <div class="widget" style="float: right; margin-top: 15px;">
                        <form method="post" id="searchform" action="{{u('home/search/index')}}">
                            <fieldset>
                                <input type="text" name="search" id="s" placeholder="简短输入您需要搜索的内容" value="{{$str}}" >
                            </fieldset>
                        </form>
                    </div><!-- end .widget -->
                </div>
            ...
            <div class="center-block-page clearfix">
                ...
                <div class="three_fourth">
                    <if value="$allSearch"><h4 style="margin-bottom: 20px;">搜索到：<span style="color: red;font-size: 40px;">{{$allSearchcount['total']}}</span> &nbsp;篇相关文章</h4>
                        <elseif value='!$allSearch && $postContent'/>
                        <h4 >没有搜索到 <span style="color: red;font-size: 40px;">'{{$postContent}}'</span>&nbsp;的相关文章！</h4>
                        <else/>
                    ...
                    <div id="accordion">
                        <foreach from="$allSearch" key="$k" value="$v">
                        <h3><a href="article_{{$v['aid']}}.html" style="font-size: 18px">{{$v['title']}}</a></h3>
                        <div>
                            <p>
                               {{$v['digest']}}
                            </p>
            ...
            <if value='!$postContent||!$allSearch && $postContent'>
