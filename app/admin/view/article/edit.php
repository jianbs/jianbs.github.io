        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-9">
                        <foreach from="$tagData" key="$k" value="$v">
                            <label class="checkbox-inline">
                                <input <if value="in_array($v['tid'],$oldTag)">checked</if> type="checkbox" name="tag[]" value="{{$v['tid']}}"> {{$v['tname']}}
                            </label>
                        </foreach>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <script id="container" style="height:300px;width:100%;" name="content">{{$oldData['content']}}</script>
                        <script>
